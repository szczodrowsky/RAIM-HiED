...
def full_db(koncentracja):
  with engine.connect() as conn:
    query = text(
      "INSERT INTO koncentracja (plec, wiek, godzina, miejsce, samopoczucie, koncentracja, problemy, pora_dnia, miejsce_koncentracja) VALUES (:plec, :wiek, :godzina, :miejsce, :samopoczucie, :koncentracja, :problemy, :pora_dnia,:miejsce_koncentracja)"
    )

    conn.execute(
      query, {
        'plec': koncentracja['plec'],
        'wiek': koncentracja['wiek'],
